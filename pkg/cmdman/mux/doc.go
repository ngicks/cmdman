...
//
// The package is split into three small files:
//
...
//     fallback `tmux`), tmux session+window construction, marker-based layout
//     cycling, and the attach-hint print when invoked outside a multiplexer.
package mux
