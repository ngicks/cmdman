...
-- end state of the embedded migration chain in internal/migrations/*.sql (0001 +
-- 0002). It exists because sqlc v1.31.1's SQLite engine silently ignores
...
-- replays internal/migrations/*.sql; this file must be kept in sync with that
-- chain's final schema whenever a migration is added.
--
