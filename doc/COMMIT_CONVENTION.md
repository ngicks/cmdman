...
| `man`       | `doc/man/`, the man pages                                       |
| `api`       | `api/`, proto schema and generated code                         |
| `cmd`       | `cmd/`, the cobra entry point                                   |
| `cmdman`    | `cmdman/`, the Service and its verbs                            |
| `cli`       | `cmdman/cli/`                                                   |
| `compose`   | `cmdman/compose/`                                               |
| `config`    | `cmdman/config/`                                                |
| `eventlog`  | `cmdman/eventlog/`                                              |
| `frame`     | `cmdman/frame/`                                                 |
| `logdriver` | `cmdman/logdriver/`                                             |
| `model`     | `cmdman/model/`                                                 |
| `monitor`   | `cmdman/monitor/`                                               |
| `mux`       | `cmdman/mux/`                                                   |
| `store`     | `cmdman/store/`, including migrations and sqlc output           |
| `tui`       | `cmdman/tui/`, including its `internal/` and `widget/`          |
| `internal`  | `internal/`, the small shared helpers                           |
| `hrstr`     | `pkg/hrstr/`                                                    |
| `muxctl`    | `pkg/muxctl/`, including the tmux driver                        |
| `stdcopy`   | `pkg/stdcopy/`                                                  |
| `e2e`       | `e2e/`                                                          |
| `apm`       | `apm.yml`, `apm.lock.yaml`, `AGENTS.md`, `.claude/rules/`       |
